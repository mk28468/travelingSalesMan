package hw4;
// Removed StdIn dependency, assertions
/*************************************************************************
...
public class MinPQ<Key> implements Iterable<Key> {
    ...
    private Key[] keyArray(int cap) { return (Key[]) new Object[cap+1]; }
    
   /**
     * Create an empty priority queue with the given initial capacity.
     */
    public MinPQ(int initCapacity) {
        pq = keyArray(initCapacity);
        N = 0;
    }
    ...
    **********************************************************************/
    @SuppressWarnings("unchecked") // Key extends Object
